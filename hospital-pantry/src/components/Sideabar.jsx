  ...
  return (
    <div>
      <ul>
        ...
        >
          <p className="font-semibold text-1.5xl">Add Patient</p>
        </NavLink>
        <NavLink
          to={"/add-diet"}
          className={({ isActive }) =>
        ...
        >
          <p className="font-semibold text-1.5xl">Add Diet</p>
        </NavLink>
        <NavLink
          to={"/add-pantrystaff"}
          className={({ isActive }) =>
        ...
        >
          <p className="font-semibold text-1.5xl">Add Pantry Staff</p>
        </NavLink>
        <NavLink
          to={"/assign-pantry"}
          className={({ isActive }) =>
        ...
        >
          <p className="font-semibold text-1.5xl">Assign Pantry</p>
        </NavLink>
      </ul>
    </div>
  );
